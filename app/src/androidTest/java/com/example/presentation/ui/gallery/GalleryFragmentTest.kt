...
import org.kumnan.aos.apps.testpractice.util.fakes.FakeUnsplashService
...
class GalleryFragmentTest {
    ...
    @Before
    fun launchScreen() {
        launchFragmentInHiltContainer<com.example.presentation.ui.gallery.GalleryFragment>()
    }
